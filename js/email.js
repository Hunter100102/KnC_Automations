...
(function () {
  ...
  function sendContactForm(e) {
    ...
    if (website !== "") {
      console.warn("Bot blocked:", form.elements["website"].value);
    ...
    emailjs
      .send(SERVICE_ID, TEMPLATE_ID, payload)
      .then(function (res) {
        // console.log('EmailJS response:', res);
        if (window.KnCAnalytics) {
          window.KnCAnalytics.track("lead_form_email_sent", {
      ...
      .catch(function (err) {
        ...
        if (window.KnCAnalytics) {
          window.KnCAnalytics.track("lead_form_email_failed", {
            form_id: "contact_form",
            delivery_provider: "emailjs",
          });
        }
